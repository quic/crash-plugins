...
DEFINE_EVENT(dma_map_page)
DEFINE_EVENT(dma_unmap_page)
DEFINE_EVENT(dma_map_resource)
DEFINE_EVENT(dma_unmap_resource)
DEFINE_EVENT(dma_alloc)
DEFINE_EVENT(dma_free)
DEFINE_EVENT(dma_map_sg)
DEFINE_EVENT(dma_unmap_sg)
DEFINE_EVENT(dma_sync_single_for_cpu)
DEFINE_EVENT(dma_sync_single_for_device)
DEFINE_EVENT(dma_sync_sg_for_cpu)
DEFINE_EVENT(dma_sync_sg_for_device)
DEFINE_EVENT(swiotlb_bounced)
